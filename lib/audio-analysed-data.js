...
class AudioAnalysedData
{
   ...
   * @param {number} energyPersistence during how much time energy data is stored and used for computations
   */
  pushNewEnergy (energy, deltaTime, energyPersistence) {    
    ...
    for (let i = this.energyHistoryDeltaTime.length-1; i >= 0; i--) {
      ...
      if (deltaTimeSum >= energyPersistence) {
   ...
   * @param {number} energyPersistence during how much time energy data is stored and used for computations
   */
  pushNewMultibandEnergy (multibandEnergy, deltaTime, energyPersistence) {
 ...
 */
class AudioAnalysedDataForVisualization
{
  /**
   * 
...
export default AudioAnalysedData;